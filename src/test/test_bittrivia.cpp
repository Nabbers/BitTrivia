...
#define BOOST_TEST_MODULE BitTrivia Test Suite

#include "test_bittrivia.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bittrivia_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
