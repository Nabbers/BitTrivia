 ...
 *
 *   // network
 *   CBitTriviaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bittrivia.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBitTriviaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBitTriviaNetwork(UniValue objIn)
    {
...
// // can be under: BitTriviaNetwork
// //   -- signature requirements : Key1(User)
// class CBitTriviaNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == BitTriviaNetwork);
//     // }
