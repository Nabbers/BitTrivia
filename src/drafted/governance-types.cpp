...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitTriviaNetwork") type = BitTriviaNetwork;
    if(strType == "BitTriviaNetworkVariable") type = BitTriviaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitTriviaNetwork) s = "BitTriviaNetwork";
    if(type == BitTriviaNetworkVariable) s = "BitTriviaNetworkVariable";
