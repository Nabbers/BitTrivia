...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitTrivia Core bittrivia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bittrivia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bittrivia transaction") + "\n" +
              "  bittrivia-tx [options] -create [commands]   " + _("Create hex-encoded bittrivia transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bittrivia transaction
