    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BITTRIVIA-light"), QVariant("light"));
    ui->theme->addItem(QString("BITTRIVIA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BITTRIVIA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BITTRIVIA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BITTRIVIA-traditional"), QVariant("trad"));
