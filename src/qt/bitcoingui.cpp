    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitTrivia Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitTrivia address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bittrivia: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitTrivia Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitTrivia Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitTrivia Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitTrivia addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitTrivia addresses"));
    ...
    openAction->setStatusTip(tr("Open a bittrivia: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitTrivia Core help message to get a list with possible BitTrivia Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitTrivia Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitTrivia network", "", count));
    } else {
...
{
    QString strTitle = tr("BitTrivia Core"); // default title
    ...
    // Append title to "BitTrivia Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
