    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitTrivia Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitTrivia Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bittrivia-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitTrivia in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BITTRIVIA, 0.1 BITTRIVIA, 1 BITTRIVIA and 10 BITTRIVIA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nabbers.atlassian.net/wiki/display/DOC/PrivateSend\">https://nabbers.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitTrivia Core is shutting down...") + "<br /><br />" +
