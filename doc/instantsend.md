...
This mechanism has been integrated into Bitcore-Node-BitTrivia which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nabbers/insight-api-bittrivia#web-socket-api](https://github.com/nabbers/insight-api-bittrivia#web-socket-api)
* API: [https://github.com/nabbers/insight-api-bittrivia#instantsend-transactions](https://github.com/nabbers/insight-api-bittrivia#instantsend-transactions)
...
By default, the BitTrivia Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitTrivia Core daemon:
