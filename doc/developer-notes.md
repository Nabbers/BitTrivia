...
BitTrivia Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as BitTrivia Core, where everyone uses
...
pay attention to for reviewers of BitTrivia Core code.

General BitTrivia Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BitTrivia Core uses tinyformat, which is type safe. Leave them out to avoid confusion
