...
Only requiring some minor changes is bittrivia.cpp.
...
Changes to bittrivia.cpp
----------------------
bittrivia.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
